...
export default function Home() {
  ...
  async function resetDatabase() {
    try {
      ...
      modalAlert('EXITO', 'Base de datos reiniciada correctamente.', 'success', false);
    } catch (error) {
      modalAlert('ERROR', `Error al reiniciar la base de datos. ERROR: ${error.message}`, 'error', false);
    }
  }
